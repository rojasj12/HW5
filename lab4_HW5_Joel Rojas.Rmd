...
```{r eval = FALSE}
model_temp1 <- lm(INCWAGE ~ AGE + female + AfAm + Asian + Amindian + race_oth + Hispanic + educ_hs + educ_somecoll + educ_college + educ_advdeg + veteran + BUILTYR2 + unmarried, data = dat_use)
summary(model_temp1)
